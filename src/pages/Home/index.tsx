...
export default function HomePage() {
  ...
  const quickActions = [
    ...
    { label: t.nav.transport, icon: Car, path: '/transport', color: 'bg-violet-50 text-violet-600' },
    ...
    <div>
      <section className="relative overflow-hidden bg-gradient-to-br from-sky-600 via-sky-500 to-teal-600 px-4 py-16 text-white sm:py-24">
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-4 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">{t.home.title}</h1>
          <p className="mx-auto mb-8 max-w-2xl text-lg text-sky-100 sm:text-xl">{t.tagline}</p>
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link to="/todo">
              <Button size="lg" className="w-full bg-white text-sky-700 hover:bg-sky-50 sm:w-auto">
                <ListTodo className="h-5 w-5" /> {t.home.thingsToDo} ({done}/{CITY_TODOS.length})
              </Button>
            </Link>
            <Link to="/city">
              <Button
              ...
              >
                <Building className="h-5 w-5" /> {t.home.smartCity}
              </Button>
            </Link>
            <Link to="/ai-guide">
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        <h2 className="mb-6 text-xl font-semibold">{t.home.cityServices}</h2>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Link to="/todo">
            <Button size="lg">
              <ListTodo className="h-5 w-5" /> {t.home.startChecklist}
            </Button>
          </Link>
          <Link to="/city">
            <Button size="lg" variant="outline">
              {t.home.openSmartCity}
            </Button>
          </Link>
        </div>
      </section>
