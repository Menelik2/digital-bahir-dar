      ...
      <div className="flex shrink-0 items-center justify-between gap-2 border-b border-slate-200 py-3 dark:border-slate-800">
        ...
        <div className="flex gap-1">
          <Link to="/trip-planner">
            <Button size="icon" variant="ghost" title="Trip planner">
  ...
  if (action.external) {
    return (
      <a
        ...
        className="inline-flex items-center gap-1 rounded-full border border-sky-200 bg-sky-50 px-2.5 py-0.5 text-[11px] font-medium text-sky-700 hover:bg-sky-100 dark:border-sky-900 dark:bg-sky-950 dark:text-sky-300"
      >
