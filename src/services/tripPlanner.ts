 ...
 * Builds day-by-day plans from simple preferences + curated knowledge.
 * Optional AI narrative via aiGuide when available.
 */
...
/** Score curated guides against user prefs */
    ...
    stops: [
      {
        ...
        time: '08:00',
        duration: '30 min',
        notes: 'Compare operators. Agree shared vs private price before boarding.',
        estimatedCostEtb: 0,
      ...
      },
      {
        ...
        time: '08:30',
        duration: '4–5 h',
        notes: 'Modest dress; shoes off in churches. Entry often separate from boat.',
    ...
    stops: [
      {
        ...
        notes: 'Bus/minibus is cheapest; private car is easier in a group.',
      ...
      },
      {
        ...
        time: '09:00',
        duration: '2–4 h',
        notes: 'Entry + optional guide. Wear good shoes; pack water.',
...
export function buildTripPlan(input: PlannerInput): PlannerResult {
  ...
  while (planDays.length < days) {
    const d = slowDay({ food: foodPer, interest: input.interests })
    d.dayNumber = dayNum++
    d.title = `Free / flexible day ${d.dayNumber}`
    planDays.push(d)
  }
  ...
  const tips = [
    ...
    'Carry cash; ATMs can run dry on busy days.',
    'Start boats and falls trips early; midday heat is strong.',
    'Modest dress for monasteries; shoes off in churches.',
    input.budget === 'budget'
      ? 'Share boats and guides when you can; walk more than bajaj.'
      : 'Hotels can arrange trusted drivers for the Falls day.',
  ]
