...
const en: Strings = {
  ...
  profile: {
    title: 'Your profile',
    signInPrompt: 'Sign in to save places, write reviews, and manage trips.',
  ...
  auth: {
    ...
    signInDesc: 'Sign in to Digital Bahir Dar',
    joinDesc: 'Join to save places and plan trips',
    email: 'Email',
    password: 'Password',
    fullName: 'Full name',
    signIn: 'Sign in',
  ...
  events: {
    title: 'Events',
    subtitle: 'Culture, markets, and seasonal highlights. Confirm time and venue locally.',
    askAi: 'Ask AI Guide',
    loading: 'Loading events…',
    empty: 'No events listed right now.',
    all: 'All',
    upcoming: 'Upcoming',
  },
  budgetPage: {
    title: 'Budget planner',
    subtitle: 'Rough ETB estimates for lodging, food, and activities in Bahir Dar.',
    nights: 'Nights',
    people: 'People',
    style: 'Style',
    ...
    openPlanner: 'Open trip planner',
    note: 'Estimates only — confirm prices on site.',
  },
  directory: {
    title: 'Bahir Dar Directory',
    subtitle: 'Browse city services, places, and emergency contacts',
    emergency: 'Emergency & help',
    emergencyBody: 'National numbers where applicable. Ask your hotel for the current recommended hospital.',
  ...
  pwa: {
    offline: 'You are offline — saved pages and local tips still work.',
    installTitle: 'Install Digital Bahir Dar',
    installBody: 'Add to your home screen for faster access.',
    install: 'Install',
    dismiss: 'Not now',
  },
  place: {
  ...
  guidesPage: {
    title: 'Guides',
    subtitle: 'Curated Bahir Dar tips and itineraries.',
    askAi: 'Ask AI Guide',
  },
  businessPage: {
    title: 'Business portal',
    subtitle: 'Register or claim your listing in Digital Bahir Dar.',
  ...
  expensesPage: {
    title: 'Expenses',
    subtitle: 'Track spending on your Bahir Dar trip.',
    add: 'Add expense',
...
const am: Strings = {
  ...
  profile: {
    ...
    loginRegister: 'ግባ / ይመዝገቡ',
    logOut: 'ውጣ',
    preferences: 'ምርጫዎች',
    language: 'ቋንቋ',
    currency: 'ምንዛሬ',
    savedPlaces: 'የተቀመጡ ቦታዎች',
    noSaved: 'እስካሁን የተቀመጠ ቦታ የለም።',
    explorePlaces: 'ቦታዎችን አስስ',
  ...
  auth: {
    ...
    signInDesc: 'ወደ ዲጂታል ባሕር ዳር ይግቡ',
    joinDesc: 'ቦታዎችን ለማስቀመጥ እና ጉዞ ለማቀድ ይቀላቀሉ',
    email: 'ኢሜይል',
    password: 'የይለፍ ቃል',
    fullName: 'ሙሉ ስም',
    signIn: 'ግባ',
    ...
    noAccount: 'መለያ የለዎትም?',
    hasAccount: 'መለያ አለዎት?',
    checkEmail: 'መለያዎን ለማረጋገጥ ኢሜይልዎን ይመልከቱ፣ ከዚያ ይግቡ።',
  },
  events: {
    title: 'ዝግጅቶች',
    subtitle: 'ባህል፣ ገበያዎች እና ወቅታዊ ዝግጅቶች። ሰዓትና ቦታ በአካባቢ ያረጋግጡ።',
    askAi: 'AI መመሪያ ጠይቅ',
    loading: 'ዝግጅቶች በመጫን ላይ…',
    empty: 'አሁን የተዘረዘረ ዝግጅት የለም።',
    all: 'ሁሉም',
    upcoming: 'መጪ',
  },
  budgetPage: {
    title: 'የበጀት እቅድ',
    subtitle: 'በባሕር ዳር ለማረፊያ፣ ምግብ እና እንቅስቃሴዎች የብር ግምቶች።',
    nights: 'ለሊቶች',
    people: 'ሰዎች',
    style: 'ዓይነት',
    calculate: 'ድምር አድስ',
    estimated: 'የተገመተ ድምር',
    perPerson: 'በሰው',
    openPlanner: 'የጉዞ እቅድ ክፈት',
    note: 'ግምቶች ብቻ — ዋጋዎችን በአካባቢ ያረጋግጡ።',
  },
  directory: {
    title: 'የባሕር ዳር ማውጫ',
    subtitle: 'የከተማ አገልግሎቶች፣ ቦታዎች እና የአደጋ ጊዜ እውቂያዎች',
    emergency: 'አደጋ ጊዜ እና እገዛ',
    emergencyBody: 'ብሔራዊ ቁጥሮች እንደሚመለከታቸው። ለሆስፒታል የአሁኑን ምክር ከሆቴልዎ ይጠይቁ።',
    practicalTips: 'ተግባራዊ ምክሮች',
    hotels: 'ሆቴሎች',
    restaurants: 'ምግብ ቤቶች',
    cafes: 'ካፌዎች',
    attractions: 'መስህቦች',
    ...
    atms: 'ATM',
    transport: 'ትራንስፖርት',
    tourGuides: 'የጉብኝት መሪዎች',
    events: 'ዝግጅቶች',
    shopping: 'ግዢ',
    map: 'ካርታ',
    hospitals: 'ሆስፒታሎች',
    pharmacies: 'ፋርማሲዎች',
    emergencyLabel: 'አደጋ ጊዜ',
  },
  pwa: {
    offline: 'ከመስመር ውጭ ነዎት — የተቀመጡ ገጾች እና አካባቢያዊ ምክሮች አሁንም ይሰራሉ።',
    installTitle: 'ዲጂታል ባሕር ዳርን ጫን',
    installBody: 'ለፈጣን መዳረሻ ወደ መነሻ ስክሪንዎ ያክሉ።',
    install: 'ጫን',
    dismiss: 'አሁን አይደለም',
  },
  place: {
  ...
  guidesPage: {
    title: 'መመሪያዎች',
    subtitle: 'የተዘጋጁ የባሕር ዳር ምክሮች እና የጉዞ እቅዶች።',
    askAi: 'AI መመሪያ ጠይቅ',
  },
  businessPage: {
    title: 'የንግድ መግቢያ',
    subtitle: 'በዲጂታል ባሕር ዳር ዝርዝርዎን ይመዝገቡ ወይም ይጠይቁ።',
    register: 'ንግድ ይመዝገቡ',
    claim: 'ዝርዝር ጥይቅ',
  ...
  expensesPage: {
    title: 'ወጪዎች',
    subtitle: 'በባሕር ዳር ጉዞዎ ላይ ወጪ ይከታተሉ።',
    add: 'ወጪ ጨምር',
    empty: 'እስካሁን ወጪ የለም።',
  },
}
